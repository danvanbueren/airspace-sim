...
- Reference point creation from the map context menu — suspended, drop-protected markers with MIL-STD control-measure symbology and auto-assigned RP## labels.
