...
export function useTrackManagementWindows({onInitiateTrack, onTrackCreated, onTrackUpdated}) {
    ...
    const initiateTrack = useCallback((elementContainer) => {
        ...
        const trackManagementWindow = {
            ...
            callsign: trackId,
            heading: elementContainer.heading !== undefined ? elementContainer.heading : 0,
            speed: elementContainer.speed !== undefined ? elementContainer.speed : '',
            altitude: elementContainer.altitude !== undefined ? elementContainer.altitude : '',
            infoFields: false,
