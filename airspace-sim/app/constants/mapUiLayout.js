/** Matches floating overlay inset in `Home.js` (`top` / `right` / `bottom` / `left: 20`). */
export const MAP_FLOATING_INSET_PX = 20
...
export const MAP_SETTINGS_FAB_RESERVE_WIDTH_PX =
    MAP_FLOATING_INSET_PX + MAP_SETTINGS_FAB_SIZE_PX + (MAP_SETTINGS_FAB_CARD_PADDING_PX * 2)
...
export const MAP_PERFORMANCE_OVERLAY_BOTTOM_PX =
    MAP_FLOATING_INSET_PX + MAP_ATTRIBUTION_BOTTOM_RESERVE_PX
