...
import { getCursorBoxPosition } from "../hooks/useCursorCoordinates"

export default function CursorCoordinateOverlay(cursorInfo, cursorBoxRef) {
    ...
    return (
        <>
            {cursorInfo && (
                ...
                >
                    LAT: {formatLatLong(cursorInfo.lat)}<br/>
