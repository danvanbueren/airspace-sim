...
import SettingsModal from "@/app/components/modals/settings/SettingsModal";

export default function QuickSettingsContainer() {
                    ...
                    >
                        ...
                        >
                            ...
                            <QuickSettingsButton
                                icon = {<SettingsIcon/>}
                                tooltip='Settings'
                                onClick={() => openModalWithState('settings')}
                            />

                            <QuickSettingsButton
                                icon = {<KeyboardIcon/>}
                                tooltip='Keybinds'
                                onClick={() => openModalWithState('keybinds')}
                            />

                            <QuickSettingsButton
                                icon = {<HistoryEduIcon/>}
                                tooltip='Roadmap'
                                onClick={() => openModalWithState('roadmap')}
                            />
                            {/*
                            ...
                            */}
                            ...
                            <QuickSettingsButton
                                icon = {<InfoIcon/>}
                                tooltip='About'
                                onClick={() => openModalWithState('about')}
                            />
                        </Box>
                    </Collapse>
                </Box>
