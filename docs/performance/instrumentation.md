...
Above the chart: FPS as `FPS (low/avg): #/#`, frame time as `Frame (peak/avg): #/# ms`, tracks in view (viewport), firm track total, and adaptive throttle % on the bottom row (highlighted above 15%).
